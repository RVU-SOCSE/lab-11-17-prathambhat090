...
join_data = emp1.join(sal1,how='inner')  # default left join
...
final = pd.concat([sales1, sales2], axis=1) # axis=0 vertical(row) , axis=1 horizontal(col)
